...
import { FaChartLine, FaArrowRight, FaCoins, FaTrendingUp, FaBullseye, FaFire, FaStar, FaChartBar, FaBookOpen, FaGraduationCap, FaUsers, FaCalendar } from 'react-icons/fa'
